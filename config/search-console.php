...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'oauth_json' => [
            'auth_config' => storage_path('app/google-apis-credentials/oauth-account-credentials.json'),
        ],
        'service_account' => [
            'application_credentials' => storage_path('app/google-apis-credentials/service-account-credentials.json'),
        ],
